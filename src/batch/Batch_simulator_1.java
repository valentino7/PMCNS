...
public class Batch_simulator_1 extends GeneralSimulator {
    ...
    public Statistics RunBatch(Rngs r) {
        ...
        // e termina quando tutti i server dentro la serverfarm ed ec2 hanno type = 0
        while (system_events.get(0).getType() != 0 ) {
            ...
            if (e == 0) { // processo un arrivo
                ...
                if (serverfarm.getWorking_task1() + serverfarm.getWorking_task2() < SERVERS) { // ho dei server liberi -> ( arrivo serverfarm )
                    ...
                    system_events.get(serverfarm_server_selected).setType(type);
