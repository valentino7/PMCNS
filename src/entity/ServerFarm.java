...
public class ServerFarm {
    ...
    //numero di tasks contenuti attualmente nel serverfarm
    private int working_task1 = 0;
    private int working_task2 = 0;

    //numero di tasks processati in totale dal serverfarm per tipo
    private int processed_task1 = 0;
    private int processed_task2 = 0;

    //lo stato di ogni server del serverfarm
